...
public class Lease_NewForfaitOverride {
    ...
    public BudgetOverrideForFixed newForfait(
            final BigDecimal forfaitValue,
        ...
        return budgetOverrideRepository.newBudgetOverrideForFixed(forfaitValue,lease,startDate,endDate,invoiceCharge,incomingCharge,type, BudgetOverrideType.FORFAIT.reason);
    }
